        ...
        {fase === "resultado" && (
          ...
          >
            ...
            <FormAdicionarAlimento
              aoAdicionar={(item) => {
                adicionarManual(item);
                return true; // aqui é só estado local — nunca falha
              }}
            />
...
// O formulário de adicionar alimento na mão virou componente compartilhado
// (FormAdicionarAlimento) — também é usado no detalhe da refeição salva.
